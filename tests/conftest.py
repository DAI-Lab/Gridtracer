...
def mock_workflow_config(sample_config, temp_output_dir):
    ...
    with patch('gridtracer.data.workflow.REGION', sample_config['region']), \
            patch('gridtracer.data.workflow.OUTPUT_DIR', temp_output_dir), \
            patch('gridtracer.data.workflow.INPUT_DATA', sample_config['input_data']), \
            patch('gridtracer.data.workflow.EPSG', sample_config['epsg']), \
            patch('gridtracer.data.workflow.LOG_LEVEL', logging.INFO), \
            patch('gridtracer.data.workflow.LOG_FILE', sample_config['log_file']):
        yield
